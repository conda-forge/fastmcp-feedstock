...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/fastmcp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/fastmcp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add fastmcp fastmcp-slim
# for installing globally
pixi global install fastmcp fastmcp-slim
```
...
It is possible to list all of the versions of `fastmcp` available on your platform:
...
```
pixi search fastmcp --channel conda-forge
```
